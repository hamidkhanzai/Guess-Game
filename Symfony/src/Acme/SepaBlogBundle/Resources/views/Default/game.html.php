...
<?php $view['slots']->set('title','Guess Game Level One')?>
<?php $view['slots']->set('header','Guess Game Level One!')?>

 <?php $view['slots']->start('body')?>
	 
	<form action="<?php echo $view['router']->generate('Game1D')?>" method="post" <?php echo $view['form']->enctype($form) ?>>
  	<table  width='400px'>
  		<tr>
...
<table widh='300px' border="1"  style ="margin: 10px; border: 4px solid #D0D0D0; -webkit-box-shadow: 0 0 8px #DDD0D0;">
<tr><th align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Scores&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>

<?php foreach ($visitors as $visit):?>
<tr>
        <td align="center">&nbsp;&nbsp;&nbsp;<?php echo $visit->getName()?></td><td align="center">&nbsp;&nbsp;&nbsp;<?php echo $visit->getFirst()?></td></tr>    
<?php endforeach;?>
</table>
<?php $view['slots']->stop()?>