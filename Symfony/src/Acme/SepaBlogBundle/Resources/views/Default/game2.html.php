...
<?php $view['slots']->set('title','Game Level Two')?>
<?php $view['slots']->set('header','Guss Game Level Two!')?>

<?php $view['slots']->start('body')?>
<form action="<?php echo $view['router']->generate('Game2D') ?>" method="post" <?php echo $view['form']->enctype($form) ?> >
<table width='400px'>
<tr><td>
...
<tr>
<td>
<?php echo $view['form']->label($form['guess2']); ?>
</td><td>
<?php echo $view['form']->widget($form['guess2']); ?>
</td>
</tr>
<tr>
<td ></td><td>
...
<tr>
        <td>&nbsp;&nbsp;&nbsp;<?php echo $visit->getName()?></td><td>&nbsp;&nbsp;&nbsp;<?php echo $visit->getSecond()?></td></tr>    
<?php endforeach;?>
</table>
<?php $view['slots']->stop()?>
